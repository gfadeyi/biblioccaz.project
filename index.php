    ...
    <div class="container-fluid px-5 my-4">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
               ...
               <?php
// On utilise maintenant les fichiers locaux dans ton dossier images/
$meilleuresVentes = [
    [
        "titre" => "Le crime du paradis", 
        "auteur" => "Guillaume Musso", 
        "prix" => 14.90, 
        "img" => "img/Le crime du paradis.jpg" 
    ],
    [
        "titre" => "Harry Potter et la Coupe de Feu", 
        "auteur" => "J.K. Rowling", 
        "prix" => 32.00, 
        "img" => "img/Harry Potter et la Coupe de Feu.jpg"
    ],
    [
        "titre" => "La chronique des Bridgerton", 
        "auteur" => "Julia Quinn", 
        "prix" => 9.50, 
        "img" => "img/La chronique des Bridgerton.jpg"
    ],
    [
        "titre" => "Heated Rivalry", 
        "auteur" => "Rachel Reid", 
        "prix" => 11.00, 
        "img" => "img/Heated Rivalry.jpg"
    ],
];
?>
